...
import (
	...
	"github.com/karokojnr/broker-service/event"
	"github.com/karokojnr/broker-service/logs"
...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	// create some json to send the the auth microservice
	...
	// make sure you get the correct status code
	...
	// create a varibale we'll read response.Body into
...
func (app *Config) logItem(w http.ResponseWriter, entry LogPayload) {
	...
	_ = app.wrtieJSON(w, http.StatusAccepted, payload)
